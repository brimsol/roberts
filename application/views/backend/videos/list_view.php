				...
				<?php echo $this -> load -> view('backend/slice/side_nav'); ?>
					...
					<div class="span8">
						...
						<tr>
							...
							<td>
							<a rel="tooltip" data-original-title="Edit Store" class="btn btn-mini" href="<?php echo site_url('admin/video/edit'); ?>/<?php echo $store -> id; ?>" ><i class="icon-edit"></i></a>
							<?php echo anchor('admin/video/delete/'.$store->id,'<i class="icon-trash icon-white"></i>',
