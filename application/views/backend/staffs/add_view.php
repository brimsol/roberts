			...
			<div class="row-fluid">
				...
				<?php echo $this -> load -> view('backend/slice/side_nav'); ?>
					...
					<div class="span9 well">
						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php site_url('admin/staffs/add'); ?>" >
							<fieldset>
								<div id="legend" class="">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Designation" class="input-large" id="designation" type="text" name="designation">
