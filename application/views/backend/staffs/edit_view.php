		...
		<div class="container">
			...
			foreach($staffs as $staffs){?>
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Name" class="input-large" id="name" type="text" name="name" value="<?php echo $staffs-> name; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Name" class="input-large" id="designation" type="text" name="designation" value="<?php echo $staffs-> designation; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="description" id="description"><?php echo $staffs-> description; ?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo base_url();?>uploads/<?php echo $staffs-> image; ?>" />
											</div>
