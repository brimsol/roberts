		...
		<div class="container">
			...
			foreach($signs as $sign){?>
								<div class="control-group">
									...
									<!-- Text input-->
									<label class="control-label" for="input01">sign Name</label>
									<div class="controls">
										<input placeholder="Name" class="input-large" id="name" type="text" name="name" value="<?php echo $sign-> name; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="description" id="description"><?php echo $sign-> description; ?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo base_url();?>uploads/<?php echo $sign-> image; ?>" />
											</div>
