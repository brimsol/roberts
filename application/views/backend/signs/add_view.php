			...
			<div class="row-fluid">
				...
				<?php echo $this -> load -> view('backend/slice/side_nav'); ?>
					...
					<div class="span10 well">
						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php site_url('admin/signs/add'); ?>" >
							<fieldset>
								<div id="legend" class="">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="sign Name" class="input-large" id="name" type="text" name="name">
