			...
			<table class="table table-hover table-striped table-bordered" id="members_result_table">
					...
					<?php	foreach ($categories as $category){?>
						<tr>
							...
							<a rel="tooltip" data-original-title="Edit Store" class="btn btn-mini" href="<?php echo site_url('admin/ourworks/category/edit'); ?>/<?php echo $category -> id; ?>" ><i class="icon-edit"></i></a>
							<?php echo anchor('admin/ourworks/category/delete/'.$category->id,'<i class="icon-trash icon-white"></i>',
