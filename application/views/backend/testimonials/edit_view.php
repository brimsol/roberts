		...
		<div class="container">
			...
			foreach($testimonials as $testimonial){?>
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Name" class="input-large" id="name" type="text" name="name" value="<?php echo $testimonial-> name; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="description" id="description"><?php echo $testimonial-> description; ?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo base_url();?>uploads/<?php echo $testimonial-> image; ?>" />
											</div>
