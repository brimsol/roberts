		...
		<div class="container">
			<div class="row-fluid">
				...
				<?php echo $this -> load -> view('backend/slice/side_nav'); ?>
					...
					<div class="span10 well">
						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php site_url('admin/gifts/edit'); ?>" >
							<fieldset>
								<div id="legend" class="">
			...
			foreach($gifts as $gifts){?>
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Name" class="input-large" id="name" type="text" name="name" value="<?php echo $gifts-> name; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="description" id="description"><?php echo $gifts-> description; ?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo base_url();?>uploads/<?php echo $gifts-> image; ?>" />
											</div>
