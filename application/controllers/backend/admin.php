...
class Admin extends CI_Controller {
	...
	public function logout() {
		...
		//$expression=get_all_cache_files();
        //print_r($expression);
		//redirect(base64_decode($url),'refresh');
		//$this->output->clear_page_cache('/dashboard/index');
		//$this->output->clear_page_cache('dashboard/index');
		//$this->output->clear_page_cache('http://roberts.app/dashboard');
		//$this -> load -> view('backend/auth/login_view');
